		...
		<div id="container-login">
			...
			<div id="container-login-right">
				<div id="header-top-right" class="header-login">
					<button id="dangnhap" onclick="dangnhap()" style="background-color: white;">Đăng nhập</button>
					<span style="font-size: 20px">/</span>
					<button id="dangky" onclick="dangky()" style="background-color: red;">Đăng ký</button>
				...
				<div id="container-center-login-right">
					<div id="form-login1">
						...
						<h3>PASSWORD</h3>
						<input id="matkhau" class="material-textinput" type="password" placeholder="password" name="matkhau"/><br>
					...
					<div id="form-signup1">
						<form action="" method="post">
							...
							<h3>PASSWORD</h3>
							<input id="matkhaudangky" class="material-textinput" type="password" placeholder="password" name="matkhaudangky"/><br><br/>
